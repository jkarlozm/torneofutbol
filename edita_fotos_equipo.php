<?php
	...
	if(!isset($_GET["id"]))
		...
		$id=$_GET["id"];
	$producto_a_modificarq=mysql_query("select * from equipos where idEquipo=$id");
    ...
    <body>
		...
		<div id="page">
			<div id="content-other">
				<div class="datagrid">
					<form method='post' class="form-horizontal form-label-left" novalidate action="bddatos/EditaFotoEquipoBD.php" enctype="multipart/form-data">
                        <span class="section">
							<?php
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="nombre_producto" class="form-control col-md-7 col-xs-12" name="nombre_producto" placeholder="" required="required" type="text" value="<?php echo $aamf['nombreEquipo']?>" disabled>
                            </div>
                        </div>
						...
						<?php 
                        	$ruta = "equiposimagenes/".$aamf["logotipoEquipo"];
                        	if (file_exists($ruta)) { ?>
		                        <div class="item form-group">
		                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="actual">Foto actual <span class="required">*</span>
		                            </label>
		                            <div class="col-md-6 col-sm-6 col-xs-12">
		                                <img class="img-responsive" src="<?php echo "equiposimagenes/".$aamf["logotipoEquipo"]?>">
									</div>
		                        </div>											
                       		<?php }
							else { ?>
