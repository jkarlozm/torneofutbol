<?php
	...
	if(!isset($_GET["id"]))
		...
		$id=$_GET["id"];
	$eamq=mysql_query("select * from arbitros where idArbitro=$id");
    ...
    <body>
		...
		<div id="page">
			<div id="content-other">
				<div class="datagrid">
					<form method='post' class="form-horizontal form-label-left" action="bddatos/ModificaArbitroBD.php" enctype="multipart/form-data">
						...
						<div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                            <input id="nombre_empleado" class="form-control col-md-7 col-xs-12"  value="<?php echo $eamf["nombreArbitro"];?>" name="nombre_empleado" required="required" type="text">
	                        </div>
	                    </div>
	                    ...
	                    <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                            <input id="apaterno_empleado" class="form-control col-md-7 col-xs-12" value="<?php echo $eamf["ap_arbitro"];?>" name="apaterno_empleado" placeholder="" required="required" type="text">
	                        </div>
	                    </div>
	                    ...
	                    <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                            <input id="amaterno_empleado" class="form-control col-md-7 col-xs-12" value="<?php echo $eamf["am_arbitro"];?>" name="amaterno_empleado" placeholder="" required="required" type="text">
	                        </div>
	                    </div>
											
						<div class="item form-group">
		                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="direccion_empleado">Rol <span class="required">*</span>
		                    </label>
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                        <input  id="rol_empleado" class="form-control col-md-7 col-xs-12" value="<?php echo $eamf["rol"];?>" name="rol_empleado" placeholder="" required="required" type="text">
		                        </div>
		                </div>
