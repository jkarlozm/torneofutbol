    ...
    <body>
	    ...
	    <div id="page">
		    <div id="content-other">
                <h3 id="otro" align="center">Alta arbitros</h3>
                <hr>
			    <div class="datagrid">
				    <form method='post' class="form-horizontal form-label-left" action="bddatos/AltaArbitrosBD.php" enctype="multipart/form-data">
                        <span class="section">
						    <?php
						...
						<div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="rol_empleado" class="form-control col-md-7 col-xs-12" data-validate-length-range="1"  name="rol_empleado" placeholder="" required="required" type="text">
                            </div>
                        </div>
