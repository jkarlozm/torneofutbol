    ...
    <body>
		...
		<div id="page">
			<div id="content-other">
				<div class="datagrid">
					<h3 class="text-center text-capitalize">Modificar Contraseña</h3>
					<hr>
					<form method='post' class="form-horizontal form-label-left" action="bddatos/ModificaContrasenaBD.php" enctype="multipart/form-data">
						...
						<div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                            <input id="contrasena_empleado" class="form-control col-md-7 col-xs-12" name="contrasena_empleado" required="required" type="password">
	                        </div>
	                    </div>
	                    ...
	                    <div class="item form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                            <input id="contrasena_empleado2" class="form-control col-md-7 col-xs-12" name="contrasena_empleado2" required="required" type="password">
	                        </div>
	                    </div>			
